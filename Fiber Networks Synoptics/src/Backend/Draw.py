...
class Drawing:
    ...
    def draw(self, filename: str, path: str):
        ...
        self.block("PDO", "PDO")
        self.block("JFO", "JFO")
        self.blockref("JSO", (0, 0), {'layer': 'SINOP_JSFO', 'xscale': 10, 'yscale': 10}, {'NAME': "JSO%d" % 200})
        self.blockref("JFO", (60, -60), {'layer': 'SINOP_JSFO', 'xscale': 10, 'yscale': 10}, {'NAME': "JFO%d" % 200})
        self.blockref("PDO", (60, 0), {'layer': 'SINOP_PDO', 'xscale': 10, 'yscale': 10}, {'NAME': "PDO%d" % 2001})
        self.blockref("PDO", (120, -60), {'layer': 'SINOP_PDO', 'xscale': 10, 'yscale': 10}, {'NAME': "PDO%d" % 2002})
        self.blockref("PDO", (120, -120), {'layer': 'SINOP_PDO', 'xscale': 10, 'yscale': 10}, {'NAME': "PDO%d" % 2003})
        self.blockref("PDO", (60, -120), {'layer': 'SINOP_PDO', 'xscale': 10, 'yscale': 10}, {'NAME': "PDO%d" % 2004})
